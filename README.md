...
In the `times.rb` file, update the `using_times` method so that it will `puts` the desired phrase `"Wingardium Leviosa"` seven times. Use the `times` method to achieve this functionality.
